...
contract SmartCalculator {
    ...
    event CalculationPerformed(string indexed operation, uint256 a, uint256 b, uint256 result);
    ...
    function performCalculation(string memory operation, uint256 a, uint256 b) public returns (uint256) {
        uint256 result;
